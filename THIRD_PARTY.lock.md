...
The original repositories and their license files are mirrored under the
remote pipeline's `third_party/` directory. The licenses are not uniform;
notably, ProPainter is limited to noncommercial use.
